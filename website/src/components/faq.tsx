...
const QA: { q: string; tag: string; tagColor: string; tagBg: string; a: ReactNode }[] = [
  ...
  { q: "支持 macOS 或 Linux 吗？", tag: "平台", tagColor: "text-cyan-400", tagBg: "bg-cyan-500/15", a: "目前仅支持 Windows 10 / 11 x64。剪贴板监听（WM_CLIPBOARDUPDATE）、全局热键（RegisterHotKey）都深度依赖 Win32 API，跨平台需要完全重写底层，暂无计划。" },
