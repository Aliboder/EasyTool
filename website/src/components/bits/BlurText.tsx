...
type FrameValue = number | string | Array<number | string>;
type Frame = Record<string, FrameValue>;
...
const buildKeyframes = (
  ...
  keys.forEach((k) => {
    keyframes[k] = [from[k] as number | string, ...steps.map((s) => s[k] as number | string)];
  });
  return keyframes;
};
